...
import { subscribeSubjects, subscribeTopics, subscribeSubtopics, subscribeQuestions, subscribeResults, subscribeUsers } from "../data-layer";
          ...
          <ResponsiveContainer width="100%" height={300}>
            <PieChart>
              <Pie data={accuracyPie} dataKey="value" outerRadius={100} label>
                {accuracyPie.map((_, i) => <Cell key={i} fill={PIE_COLORS[i % PIE_COLORS.length]} />)}
              </Pie>
              <Tooltip />
            </PieChart>
          </ResponsiveContainer>
      ...
      <div className="table-card">
        ...
        <div className="um-table-wrapper">
          <table className="data-table">
            <thead>
              <tr>
                <th>Date & Time</th><th>User</th><th>Subject</th><th>Topic</th>
                <th>SubTopic</th><th>Score</th><th>Accuracy</th><th>Correct</th><th>Wrong</th><th>Actions</th>
              </tr>
            </thead>
            <tbody>
              {recentResults.length === 0 ? (
                ...
                return (
                  <tr key={r.id}>
                    ...
                    <td>{resolveSubject(r)}</td><td>{resolveTopic(r)}</td><td>{resolveSubTopic(r)}</td>
